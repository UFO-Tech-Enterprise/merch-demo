...
export const roles = [
  {
    ...
    icon: <MobileOutlined />,
    summaries: {
      app: "Польова робота в торговій точці: маршрут, чек-лист, аудит полиці, фотофіксація, залишки, ДМП, промо-цінники та доручення.",
      admin:
  ...
  },
  {
    ...
    icon: <TeamOutlined />,
    summaries: {
      app: "Операційний контроль команди: статуси зміни, активні маршрути, прогрес задач, QR-підтвердження і допомога на складних візитах.",
      admin:
